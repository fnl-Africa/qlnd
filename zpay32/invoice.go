...
type Invoice struct {
	...
	// Optional.
	FallbackAddr qtumsuite.Address
...
func FallbackAddr(fallbackAddr qtumsuite.Address) func(*Invoice) {
	return func(i *Invoice) {
...
func parseFallbackAddr(data []byte, net *chaincfg.Params) (qtumsuite.Address, error) {
	...
	case 0:
		...
		switch len(witness) {
		case 20:
			addr, err = qtumsuite.NewAddressWitnessPubKeyHash(witness, net)
		case 32:
			addr, err = qtumsuite.NewAddressWitnessScriptHash(witness, net)
		default:
	...
	case 17:
		...
		addr, err = qtumsuite.NewAddressPubKeyHash(pubKeyHash, net)
		if err != nil {
			return nil, err
		}
	case 18:
		...
		addr, err = qtumsuite.NewAddressScriptHashFromHash(scriptHash, net)
		if err != nil {
			return nil, err
		}
	default:
