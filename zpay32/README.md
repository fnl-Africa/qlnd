...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/qtumproject/qlnd/zpay32)
...
```bash
$ go get -u github.com/qtumproject/qlnd/zpay32
```
