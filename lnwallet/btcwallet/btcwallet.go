...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) ConfirmedBalance(confs int32) (qtumsuite.Amount, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) NewAddress(t lnwallet.AddressType, change bool) (qtumsuite.Address, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) IsOurAddress(a qtumsuite.Address) bool {
...
func (b *BtcWallet) SendOutputs(outputs []*wire.TxOut,
	...
	// SendOutputs.
	feeSatPerKB := qtumsuite.Amount(feeRate.FeePerKVByte())
...
func (b *BtcWallet) ListUnspentWitness(minConfs, maxConfs int32) (
	...
	for _, output := range unspentOutputs {
		...
		if addressType == lnwallet.WitnessPubKey ||
			...
			// BTC to satoshis.
			amt, err := qtumsuite.NewAmount(output.Amount)
			if err != nil {
				return nil, err
			}
...
func minedTransactionsToDetails(
	...
	for _, tx := range block.Transactions {
		...
		var destAddresses []qtumsuite.Address
