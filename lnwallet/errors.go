...
func ErrChanReserveTooSmall(reserve, dustLimit qtumsuite.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve qtumsuite.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize qtumsuite.Amount) ReservationError {
	return ReservationError{
