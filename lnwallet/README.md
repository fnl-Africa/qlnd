...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/qtumproject/lnd/lnwallet)
...
```bash
$ go get -u github.com/qtumproject/lnd/lnwallet
```
