...
func testAddSettleWorkflow(t *testing.T, tweakless bool) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(qtumsuite.SatoshiPerBitcoin)
	...
	mSatTransferred := lnwire.NewMSatFromSatoshis(qtumsuite.SatoshiPerBitcoin)
...
func TestCheckCommitTxSize(t *testing.T) {
	...
	checkSize := func(channel *LightningChannel, count int) {
		...
		actualCost := blockchain.GetTransactionWeight(qtumsuite.NewTx(commitTx))
...
func TestHTLCDustLimit(t *testing.T) {
	...
	// Bob's dust limit.
	htlcSat := (qtumsuite.Amount(500) + htlcTimeoutFee(
...
func TestHTLCSigNumber(t *testing.T) {
	...
	createChanWithHTLC := func(htlcValues ...qtumsuite.Amount) (
	...
	belowDust := qtumsuite.Amount(500) + htlcTimeoutFee(feePerKw)
	aboveDust := qtumsuite.Amount(1400) + htlcSuccessFee(feePerKw)
...
func TestCancelHTLC(t *testing.T) {
	...
	// of the new HTLC.
	aliceExpectedBalance := qtumsuite.Amount(qtumsuite.SatoshiPerBitcoin*4) -
		calcStaticFee(1)
	...
	expectedBalance := qtumsuite.Amount(qtumsuite.SatoshiPerBitcoin * 5)
	if aliceChannel.channelState.LocalCommitment.LocalBalance.ToSatoshis() !=
...
func TestCooperativeCloseDustAdherence(t *testing.T) {
	...
	setDustLimit := func(dustVal qtumsuite.Amount) {
	...
	// satoshis.
	dustLimit := qtumsuite.Amount(10000)
	...
	aliceFee := qtumsuite.Amount(aliceChannel.CalcFee(aliceFeeRate)) + 1000
	...
	bobFee := qtumsuite.Amount(bobChannel.CalcFee(bobFeeRate)) + 1000
	...
	aliceBal := lnwire.NewMSatFromSatoshis(qtumsuite.SatoshiPerBitcoin)
...
func TestAddHTLCNegativeBalance(t *testing.T) {
	...
	htlcAmt = lnwire.NewMSatFromSatoshis(2 * qtumsuite.SatoshiPerBitcoin)
...
func TestFeeUpdateOldDiskFormat(t *testing.T) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(0.1 * qtumsuite.SatoshiPerBitcoin)
	const numHTLCs = 30
...
func TestDesyncHTLCs(t *testing.T) {
	...
	htlcAmt := lnwire.NewMSatFromSatoshis(4.1 * qtumsuite.SatoshiPerBitcoin)
	htlc, _ := createHTLC(0, htlcAmt)
	...
	htlcAmt = lnwire.NewMSatFromSatoshis(1 * qtumsuite.SatoshiPerBitcoin)
...
func TestMaxPendingAmount(t *testing.T) {
	...
	maxPending := lnwire.NewMSatFromSatoshis(qtumsuite.SatoshiPerBitcoin * 3)
	...
	const numHTLCs = 2
	htlcAmt := lnwire.NewMSatFromSatoshis(1.5 * qtumsuite.SatoshiPerBitcoin)
	for i := 0; i < numHTLCs; i++ {
		htlc, _ := createHTLC(i, htlcAmt)
		if _, err := aliceChannel.AddHTLC(htlc, nil); err != nil {
			t.Fatalf("unable to add htlc: %v", err)
...
func assertChannelBalances(t *testing.T, alice, bob *LightningChannel,
	aliceBalance, bobBalance qtumsuite.Amount) {
...
func TestChanReserve(t *testing.T) {
	...
	setupChannels := func() (*LightningChannel, *LightningChannel, func()) {
		...
		aliceMinReserve := qtumsuite.Amount(0.5 *
			qtumsuite.SatoshiPerBitcoin)
		...
		bobMinReserve := qtumsuite.Amount(6 * qtumsuite.SatoshiPerBitcoin)
	...
	//	Alice:	4.5
	//	Bob:	5.0
	htlcAmt := lnwire.NewMSatFromSatoshis(0.5 * qtumsuite.SatoshiPerBitcoin)
	...
	assertChannelBalances(
		...
		qtumsuite.SatoshiPerBitcoin*4.5-commitFee, qtumsuite.SatoshiPerBitcoin*5,
	)
	...
	//	Alice:	1.5
	//	Bob:	9.5
	htlcAmt = lnwire.NewMSatFromSatoshis(3.5 * qtumsuite.SatoshiPerBitcoin)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		qtumsuite.SatoshiPerBitcoin*3-commitFee, qtumsuite.SatoshiPerBitcoin*5,
	)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		qtumsuite.SatoshiPerBitcoin*3-commitFee, qtumsuite.SatoshiPerBitcoin*7,
	)
	...
	assertChannelBalances(
		t, aliceChannel, bobChannel,
		qtumsuite.SatoshiPerBitcoin*3-commitFee, qtumsuite.SatoshiPerBitcoin*6,
	)
}
...
func TestMinHTLC(t *testing.T) {
	...
	minValue := lnwire.NewMSatFromSatoshis(0.1 * qtumsuite.SatoshiPerBitcoin)
...
func TestNewBreachRetributionSkipsDustHtlcs(t *testing.T) {
	...
	dustValue := qtumsuite.Amount(200)
