...
type ChannelController interface {
	...
	OpenChannel(target *btcec.PublicKey, amt qtumsuite.Amount) error
	...
	// should be returned.
	SpliceIn(chanPoint *wire.OutPoint, amt qtumsuite.Amount) (*Channel, error)
	...
	SpliceOut(chanPoint *wire.OutPoint, amt qtumsuite.Amount) (*Channel, error)
}
