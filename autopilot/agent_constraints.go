...
type AgentConstraints interface {
	...
	ChannelBudget(chans []Channel, balance qtumsuite.Amount) (
		qtumsuite.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize qtumsuite.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []Channel,
	funds qtumsuite.Amount) (qtumsuite.Amount, uint32) {
	...
	var totalChanAllocation qtumsuite.Amount
	...
	targetAllocation := qtumsuite.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() qtumsuite.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() qtumsuite.Amount {
