...
[In this PR](https://github.com/qtumproject/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/qtumproject/lnd/aezeed
...
PASS
ok      github.com/qtumproject/lnd/aezeed  4.168s
```
