...
[In this PR](https://github.com/qtumproject/qlnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/qtumproject/qlnd/aezeed
...
PASS
ok      github.com/qtumproject/qlnd/aezeed  4.168s
```
