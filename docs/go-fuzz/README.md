...
```
$ go-fuzz-build github.com/qtumproject/qlnd/lnwire/<folder name here>
```
* Now, run `go-fuzz`!!!
```
...
this earlier, `go-fuzz` found two bugs ([#310](https://github.com/qtumproject/qlnd/pull/310) and [#312](https://github.com/qtumproject/qlnd/pull/312)) within minutes!
