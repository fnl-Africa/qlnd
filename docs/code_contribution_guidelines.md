...
- Changes to publicly exported packages such as
  [brontide](https://github.com/qtumproject/qlnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/qtumproject/qlnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/qtumproject/qlnd/blob/master/lnd_test.go#L181). 
...
[perusing the make file documentation](https://github.com/qtumproject/qlnd/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/qtumproject/qlnd/blob/master/lnrpc/README.md).
...
Rejoice as you will now be listed as a [contributor](https://github.com/qtumproject/qlnd/graphs/contributors)!
...
[MIT license](https://github.com/qtumproject/qlnd/blob/master/LICENSE).  This is
