...
// policy's fee rate.
func (p *Policy) ComputeAltruistOutput(totalAmt qtumsuite.Amount,
	txWeight int64) (qtumsuite.Amount, error) {
...
func (p *Policy) ComputeRewardOutputs(totalAmt qtumsuite.Amount,
	txWeight int64) (qtumsuite.Amount, qtumsuite.Amount, error) {
...
func ComputeRewardAmount(total qtumsuite.Amount, base, rate uint32) qtumsuite.Amount {
	rewardBase := qtumsuite.Amount(base)
	rewardRate := qtumsuite.Amount(rate)
...
func (p *Policy) ComputeJusticeTxOuts(totalAmt qtumsuite.Amount, txWeight int64,
